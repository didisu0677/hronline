            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown"> 
                        <a class="dropdown-item<?php if($cur_menu == 'pengumuman' && ($cur_sub == '' || $cur_sub == 'index')) echo ' active'; ?>" href="<?php echo base_url('pengumuman'); ?>">Lowongan Terbaru</a>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link btn-daftar" href="javascript:;">Kirim Aplikasi</a>
                </li>
            </ul>

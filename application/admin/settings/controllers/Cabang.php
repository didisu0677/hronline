...
class Cabang extends BE_Controller {
	...
	function save() {
		$response = save_data('tbl_m_cabang',post(),post(':validation'));
	...
	function template() {
		...
		$arr = ['kode' => 'kode','nama' => 'nama','singkatan' => 'singkatan','is_active' => 'is_active'];
		$config[] = [
	...
	function import() {
		...
		$col = ['kode','nama','singkatan','is_active'];
	...
	function export() {
		ini_set('memory_limit', '-1');
		$arr = ['kode' => 'Kode','nama' => 'Nama','singkatan' => 'Singkatan','is_active' => 'Aktif'];

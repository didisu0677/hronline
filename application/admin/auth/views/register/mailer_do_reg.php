<p style="text-align: justify;">Pendaftaran Pelamar Kerja (Job Applicant) <?php echo setting('company'); ?> atas nama <strong>"<?php echo $pelamar['nama']; ?>"</strong> Berhasil. Selanjutnya silahkan lengkapi dokumen persyaratan baik secara fisik maupun secara sistem.</p>

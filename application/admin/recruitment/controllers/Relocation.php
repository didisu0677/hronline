...
class Relocation extends BE_Controller {
	...
	function data() {
		...
		$config['where']['left(tbl_disposisi.deskripsi,2)'] = '08';
	...
	function cetak_relocation($encode_id='') {

...
class Internal_transfer extends BE_Controller {
	...
	function data() {
		...
		$config['where']['left(tbl_disposisi.deskripsi,2)'] = '09';
	...
	function save() {
		$data['deskripsi'] = '09-Internal_transfer';
		...
		if($disposisi) {
			...
			$data = [
				...
				'deskripsi' => '09-Internal_transfer',
				'education' => '',
	...
	function cetak_inttransfer($encode_id='') {

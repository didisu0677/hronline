...
class Acting_status extends BE_Controller {
	...
	function data() {
		...
		$config['where']['left(tbl_disposisi.deskripsi,2)'] = '06';
	...
	function cetak_actstatus($encode_id='') {

...
class Terminate extends BE_Controller {
	...
	function data() {
		...
		$config['where']['left(tbl_disposisi.deskripsi,2)'] = '03';
	...
	function cetak_terminate($encode_id='') {

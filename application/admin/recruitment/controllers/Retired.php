...
class Retired extends BE_Controller {
	...
	function data() {
		...
		$config['where']['left(tbl_disposisi.deskripsi,2)'] = '11';
	...
	function cetak_retired($encode_id='') {

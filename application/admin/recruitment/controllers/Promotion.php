...
class Promotion extends BE_Controller {
	...
	function data() {
		...
		$config['where']['left(tbl_disposisi.deskripsi,2)'] = '05';
	...
	function cetak_promosi($encode_id='') {

...
<div class="content-body">
	<?php
	table_open('',true,base_url('recruitment/terminate/data'),'tbl_disposisi');
		thead();
			tr();
...
modal_open('modal-form','','modal-lg','data-openCallback="openForm"');
	modal_body();
		form_open(base_url('recruitment/terminate/save'),'post','form');
			col_init(3,9);
			col_init(3,9);
...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('recruitment/terminate/import'),'post','form-import');
			col_init(3,9);

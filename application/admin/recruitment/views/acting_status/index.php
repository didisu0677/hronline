...
<div class="content-body">
	<?php
	table_open('',true,base_url('recruitment/acting_status/data'),'tbl_disposisi');
		thead();
			tr();
...
modal_open('modal-form','','modal-lg','data-openCallback="openForm"');
	modal_body();
		form_open(base_url('recruitment/acting_status/save'),'post','form');
			col_init(3,9);
			col_init(3,9);
...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('recruitment/acting_status/import'),'post','form-import');
			col_init(3,9);
...
function view_combo() {
	...
	$.ajax({
		url			: base_url + 'recruitment/acting_status/get_combo',
 		dataType	: 'json',
...
$(document).on('click','.btn-print',function(){
	...
	$.redirect(base_url + 'recruitment/acting_status/cetak_actstatus/' + id, {} , 'get', '_blank');
});

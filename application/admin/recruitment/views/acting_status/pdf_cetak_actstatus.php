...
<table style="margin-bottom: 10px" width="100%">
	<tr>
    <td>We kindly request your approval for the <u><?php echo $posisi_disposisi; ?></u>  who has passed their probation as an Acting status  as follows :</td>
	</tr>

</table>
<h3 style="text-align: center; font-size: 14px; margin-bottom: 0;">PASS PROBATION FROM ACTING STATUS</h3>
<br>

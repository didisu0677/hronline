...
<div class="content-body">
	<?php
	table_open('',true,base_url('recruitment/rejoin/data'),'tbl_disposisi');
		thead();
			tr();
...
modal_open('modal-form','','modal-lg','data-openCallback="openForm"');
	modal_body();
		form_open(base_url('recruitment/rejoin/save'),'post','form');
			col_init(3,9);
			col_init(3,9);
...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('recruitment/rejoin/import'),'post','form-import');
			col_init(3,9);
...
function view_combo() {
	...
	$.ajax({
		url			: base_url + 'recruitment/rejoin/get_combo',
 		dataType	: 'json',
...
$(document).on('click','.btn-print',function(){
	...
	$.redirect(base_url + 'recruitment/rejoin/cetak_rejoin/' + id, {} , 'get', '_blank');
});

...
<table style="margin-bottom: 10px" width="100%">
	<tr>
		<td>We kindly request your approval to the new  <u><?php echo $posisi_disposisi; ?></u>  as follows :</td>
	</tr>

</table>
<h3 style="text-align: center; font-size: 14px; margin-bottom: 0;">REPLACEMENT <?php echo $posisi_disposisi . ' - ' ; echo ($divisi=='COMMON') ? 'BACKOFFICE' : $divisi?></h3>
<br>

...
<div class="content-body">
	<?php
	table_open('',true,base_url('recruitment/internal_transfer/data'),'tbl_disposisi');
		thead();
			tr();
...
modal_open('modal-form','','modal-lg','data-openCallback="openForm"');
	modal_body();
		form_open(base_url('recruitment/internal_transfer/save'),'post','form');
			col_init(3,9);
			col_init(3,9);
...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('recruitment/internal_transfer/import'),'post','form-import');
			col_init(3,9);
...
function view_combo() {
	...
	$.ajax({
		url			: base_url + 'recruitment/internal_transfer/get_combo',
 		dataType	: 'json',
...
$(document).on('click','.btn-print',function(){
	...
	$.redirect(base_url + 'recruitment/internal_transfer/cetak_inttransfer/' + id, {} , 'get', '_blank');
});
